...
input::mouse_handler::mouse_handler(std::shared_ptr<client> client)
    : client(client)
{
}

void input::mouse_handler::event(const SDL_MouseButtonEvent& event)
{
    switch (event.type)
    {
...
void input::mouse_handler::event(const SDL_MouseMotionEvent& event)
{
...
void input::mouse_handler::mouseDown(Uint8 button, Uint16 x, Uint16 y)
{
...
void input::mouse_handler::mouseUp(Uint8 button, Uint16 x, Uint16 y)
{
    client->cameraController->mouseUp(button, x, y);
}

void input::mouse_handler::mouseMove(Uint16 x, Uint16 y, Sint16 xrel, Sint16 yrel)
{
